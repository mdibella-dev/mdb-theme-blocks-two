<?php
/*
 * Plugin Name:     Marco Di Bella - Blocks
 * Plugin URI:      https://github.com/mdibella-dev/mdb-theme-blocks
 * Description:     This plugin adds custom blocks to the Gutenberg editor for use in Marco Di Bella's personal WordPress theme (mdb-theme-fse).
