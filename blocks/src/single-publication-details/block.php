...
function render_block__single_publication_details( $attributes, $content, $block ) {
    ...
    <p><?php echo publication\build_citation( $block->context['postId'] ); ?></p>
...
function register_block__single_publication_details() {
    ...
    register_block_type_from_metadata(
        __DIR__,
        [
            'render_callback' => __NAMESPACE__ . '\render_block__single_publication_details',
        ]
    );
}

add_action( 'init', __NAMESPACE__ . '\register_block__single_publication_details' );
